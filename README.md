...
* Rolling Stones fans should be able to see information on any upcoming gigs.
...
* Front page
    -carousel slide with 3 eye catching images
...
- [JQuery](https://jquery.com)
    - Use **JQuery** for fancybox in display images from gallery and carousel

- [font-awesome](https://fontawesome.com/)
    - We use **font-awesome** to get use of fonts and icons used on the creation of the site
...
- All external links i.e. social media links work as expected.
- Carousel works correctly.
- Video and audio controls have been checked an work as expected
- All code used on the site has been tested to ensure everything is working as expected
- Site viewed and tested in the following browsers:
  - Google Chrome
  - Mozilla Firefox    (Audio controls display differently then Chrome and one image on the gallery did not display)
- Contact form tests
    - Name is a required field
    - email is required and must have a '@' contained with in the test.
    - Phone number is a required field.
    - Type of event, can only choose the options permitted.
    - Event date, you can only enter a valid date.
    - Location can only be a valid country.
...
### Header: 
- The Menu for mobile and Ipad screens collapses and is displayed as drop down on left top corner.
- Social media icons disappear of top and move to the footer for mobile and iPad screens
- The rolling stone icon disappears for mobile and Ipad screens

### Footer 
- Becomes visible on small screens only (mobile and Ipad screens).
...
- jagger.png was obtained from https://www.vanityfair.com/magazine/photos/2016/03/mick-jagger-keith-richards
- 052617_rw.png was obtained from https://variety.com/2017/music/news/rolling-stones-ronnie-wood-cancer-diagnosis-1202517413/
- RSorginal.png was obtained from https://nerdist.com/wp-content/uploads/2018/08/Rolling-Stones.jpg
- rs-live-getty-cuba.png was obtained from https://www.independent.co.uk/arts-entertainment/music/news/rolling-stones-cuba-concert-havana-free-mick-jagger-keith-richards-a6905651.html
- jw-etccanada was obtained from https://etcanada.com/news/303969/the-rolling-stones-drummer-charlie-watts-says-david-bowie-wasnt-this-musical-genius/
- rs_dublin.png was obtained from https://www.dublinlive.ie/whats-on/music-nightlife-news/what-time-rolling-stones-stage-14672638
- rs_1969_us_tour.png was obtained from http://content.time.com/time/photogallery/0,29307,1710013,00.html
- keith-richards.png was obtained from https://www.planetrock.com/news/rock-news/listen-keith-richards-talks-uk-tour-new-rolling-stones-album-and-retirement/
